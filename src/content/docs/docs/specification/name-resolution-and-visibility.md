...
$$
\begin{array}{l}
\mathsf{ResolveQualifiedForm}\ :\ \mathsf{Expr}\ \rightharpoonup \ \mathsf{Expr} \\
\mathsf{ResolveArgs}\ :\ [\mathsf{Arg}]\ \rightharpoonup \ [\mathsf{Arg}] \\
\mathsf{ResolveFieldInits}\ :\ [\mathsf{FieldInit}]\ \rightharpoonup \ [\mathsf{FieldInit}] \\
