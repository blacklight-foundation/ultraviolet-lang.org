...
$$
\begin{array}{l}
x\ \in \ \operatorname{UniqueCaptures}(C)\quad c\ =\ \operatorname{Code}(\mathsf{Capture}-\mathsf{Unique}-\mathsf{Err}) \\[0.16em]
\rule{18em}{0.4pt} \\[0.16em]
...
$$
\begin{array}{l}
\exists \ i.\ \operatorname{Annot}(\operatorname{Params}(C)\_i)\ =\ \bot \quad \operatorname{ExpectedType}(C)\ =\ \bot \quad c\ =\ \operatorname{Code}(\mathsf{Infer}-\mathsf{Closure}-\mathsf{Params}-\mathsf{Err}) \\[0.16em]
\rule{18em}{0.4pt} \\[0.16em]
...
\exists \ x\ \in \ \mathsf{MoveCaps}.\ \operatorname{Lookup_B}(\mathfrak{B} ,\ x)\ =\ \langle s,\ \mathsf{mov},\ \_,\ \_\rangle \ \land \ s\ \ne \ \mathsf{Valid}\ \land \ \mathsf{mov}\ =\ \mathsf{mov}\quad c\ =\ \operatorname{Code}(B-\mathsf{Closure}-\mathsf{MoveCapture}-\mathsf{Moved}-\mathsf{Err}) \\[0.16em]
\rule{18em}{0.4pt} \\[0.16em]
...
\begin{array}{l}
C\ =\ \operatorname{ClosureExpr}(\mathsf{params},\ \mathsf{ret}_{\mathsf{type}\_\mathsf{opt}},\ \mathsf{body})\quad \mathsf{MoveCaps}\ =\ \operatorname{ClosureMoveCaptures}(C) \\[0.16em]
\exists \ x\ \in \ \mathsf{MoveCaps}.\ \operatorname{Lookup_B}(\mathfrak{B} ,\ x)\ =\ \langle \_,\ \mathsf{mv},\ \_,\ \_\rangle \ \land \ \mathsf{mv}\ =\ \mathsf{immov}\quad c\ =\ \operatorname{Code}(B-\mathsf{Closure}-\mathsf{MoveCapture}-\mathsf{Immovable}-\mathsf{Err}) \\[0.16em]
\rule{18em}{0.4pt} \\[0.16em]
\Gamma ;\ \mathfrak{B} ;\ \Pi \ \vdash \ C\ \Uparrow \ c
\end{array}
$$
...
\exists \ x\ \in \ \mathsf{RefCaps}.\ \operatorname{Lookup_B}(\mathfrak{B} ,\ x)\ =\ \langle s,\ \_,\ \_,\ \_\rangle \ \land \ s\ \ne \ \mathsf{Valid}\quad c\ =\ \operatorname{Code}(B-\mathsf{Closure}-\mathsf{RefCapture}-\mathsf{Moved}-\mathsf{Err}) \\[0.16em]
\rule{18em}{0.4pt} \\[0.16em]
\Gamma ;\ \mathfrak{B} ;\ \Pi \ \vdash \ C\ \Uparrow \ c
\end{array}
$$
...
\begin{array}{l}
\Gamma ;\ R;\ L\ \vdash \ e_{1}\ :\ T_{1}\quad \Gamma ;\ R;\ L\ \vdash \ e_{2}\ :\ T_{f} \\[0.16em]
T_{f}\ \ne \ \operatorname{TypeFunc}(\_,\ \_)\quad T_{f}\ \ne \ \operatorname{TypeClosure}(\_,\ \_,\ \_)\quad c\ =\ \operatorname{Code}(T-\mathsf{Pipeline}-\mathsf{NotCallable}-\mathsf{Err}) \\[0.16em]
\rule{18em}{0.4pt} \\[0.16em]
...
\lnot (\Gamma \ \vdash \ T_{1}\ \mathrel{<:} \ T_{p})\quad c\ =\ \operatorname{Code}(T-\mathsf{Pipeline}-\mathsf{TypeMismatch}-\mathsf{Err}) \\[0.16em]
\rule{18em}{0.4pt} \\[0.16em]
\Gamma ;\ R;\ L\ \vdash \ \operatorname{PipelineExpr}(e_{1},\ e_{2})\ \Uparrow \ c
\end{array}
$$
