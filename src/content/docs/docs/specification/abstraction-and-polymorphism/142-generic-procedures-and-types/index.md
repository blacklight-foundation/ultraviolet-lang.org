...
$$
\begin{array}{l}
\Gamma ;\ R;\ L\ \vdash \ e\ \Rightarrow \ S\ \dashv \ C\quad \operatorname{StripPerm}(S)\ =\ \operatorname{TypeApply}(\mathsf{path},\ [S_{1},\ \ldots ,\ S_{n}])\quad \operatorname{StripPerm}(T)\ =\ \operatorname{TypeApply}(\mathsf{path},\ [T_{1},\ \ldots ,\ T_{n}])\quad \exists \ i,\ \operatorname{VarianceOf}(\mathsf{path},\ i)\ =\ \texttt{=}\ \land \ \lnot (\Gamma \ \vdash \ S_{i}\ \equiv \ T_{i})\quad c\ =\ \operatorname{Code}(\mathsf{Chk}-\mathsf{Generic}-\mathsf{Invariant}-\mathsf{Err}) \\[0.16em]
\rule{18em}{0.4pt} \\[0.16em]
...
$$
\begin{array}{l}
\Gamma ;\ R;\ L\ \vdash \ e\ \Rightarrow \ S\ \dashv \ C\quad \operatorname{StripPerm}(S)\ =\ \operatorname{TypeApply}(\mathsf{path},\ [S_{1},\ \ldots ,\ S_{n}])\quad \operatorname{StripPerm}(T)\ =\ \operatorname{TypeApply}(\mathsf{path},\ [T_{1},\ \ldots ,\ T_{n}])\quad \exists \ i,\ \operatorname{VarianceOf}(\mathsf{path},\ i)\ \in \ \{\texttt{+},\ \texttt{-}\}\ \land \ \lnot \ \operatorname{VarianceSatisfied}(\operatorname{VarianceOf}(\mathsf{path},\ i),\ S_{i},\ T_{i})\quad c\ =\ \operatorname{Code}(\mathsf{Chk}-\mathsf{Generic}-\mathsf{Variance}-\mathsf{Err}) \\[0.16em]
\rule{18em}{0.4pt} \\[0.16em]
\Gamma ;\ R;\ L\ \vdash \ e\ \Leftarrow \ T\ \Uparrow \ c
\end{array}
$$
