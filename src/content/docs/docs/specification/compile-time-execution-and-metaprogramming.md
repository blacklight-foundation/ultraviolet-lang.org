...
$$
\mathsf{Any}\ \texttt{CtBuiltinCall}\ \mathsf{that}\ \mathsf{emits}\ \mathsf{declarations}\ \mathsf{appends}\ \mathsf{them}\ \mathsf{to}\ \texttt{CtPendingEmits(Phi)}.\ \mathsf{Before}\ \texttt{CtExpandItem}\ \mathsf{returns}\ \mathsf{to}\ \texttt{CtExpandItemSeq},\ \mathsf{it}\ \mathsf{MUST}\ \mathsf{transfer}\ \mathsf{the}\ \mathsf{accumulated}\ \texttt{CtPendingEmits(Phi)}\ \mathsf{into}\ \mathsf{its}\ \mathsf{returned}\ \texttt{emit\_items}\ \mathsf{list}\ \mathsf{in}\ \mathsf{append}\ \mathsf{order}\ \mathsf{and}\ \mathsf{clear}\ \mathsf{the}\ \mathsf{pending}-\mathsf{emission}\ \mathsf{queue}\ \mathsf{in}\ \mathsf{the}\ \mathsf{resulting}\ \texttt{Phi}.
$$
...
$$
\mathsf{Project}-\mathsf{file}\ \mathsf{reads}\ \mathsf{MUST}\ \mathsf{observe}\ \mathsf{the}\ \texttt{CtFiles(Phi)}\ \mathsf{snapshot}\ \mathsf{captured}\ \mathsf{at}\ \mathsf{the}\ \mathsf{start}\ \mathsf{of}\ \mathsf{Phase}\ 2.\ \mathsf{Host}\ \mathsf{writes}\ \mathsf{during}\ \mathsf{compilation}\ \mathsf{MUST}\ \mathsf{NOT}\ \mathsf{change}\ \mathsf{the}\ \mathsf{values}\ \mathsf{returned}\ \mathsf{by}\ \texttt{FSReadFile},\ \texttt{FSReadBytes},\ \texttt{FSExists},\ \mathsf{or}\ \texttt{DirEntries}\ \mathsf{through}\ \mathsf{that}\ \mathsf{snapshot}\ \mathsf{for}\ \mathsf{the}\ \mathsf{same}\ \mathsf{restricted}\ \mathsf{path}.
$$
