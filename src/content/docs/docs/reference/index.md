---
title: Reference
description: Specification and technical references for Ultraviolet.
---

Use the reference section when you need exact rules.
...
- [Runtime and Built-ins](/docs/reference/runtime-and-builtins/)
- [Target Profiles and ABI](/docs/reference/target-profiles-and-abi/)
- [Compiler Architecture](/docs/reference/compiler-architecture/)

## Main specification chapters
